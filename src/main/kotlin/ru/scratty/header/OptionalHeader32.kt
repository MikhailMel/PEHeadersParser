...
data class OptionalHeader32(
    ...
    val sizeOfStackReserve: DWord,
    val sizeOfStackCommit: DWord,
    val sizeOfHeapReserve: DWord,
    val sizeOfHeapCommit: DWord,
    ...
    override fun toString() = StringBuilder()
        ...
        .appendln(String.format("0x%-16XRVA начала данных программы", baseOfData.value))
